...
class _StatusNotaTempoScreenState extends State<StatusNotaTempoScreen> {
  ...
  'keterangan': 'notatempo', // Pastikan data ini benar
              ...
              builder: (context) => AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text('Keterangan: $keterangan'), // Pastikan keterangan ditampilkan
                    SizedBox(height: 10),
                    Text('Rincian Produk:'),
                    SizedBox(height: 10),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Keterangan: $keterangan', // Pastikan keterangan ini tampil
